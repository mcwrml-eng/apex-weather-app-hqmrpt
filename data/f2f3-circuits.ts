...
export const f2Circuits: Circuit[] = [
  ...
  { slug: 'madrid-ring-f2', name: 'Madrid Ring', country: 'Spain', latitude: 40.4168, longitude: -3.7038 },
...
export const f3Circuits: Circuit[] = [
  ...
  { slug: 'madrid-ring-f3', name: 'Madrid Ring', country: 'Spain', latitude: 40.4168, longitude: -3.7038 },
];
