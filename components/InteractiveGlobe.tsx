...
Now let's add the globe to the main screens. I'll update the F1, MotoGP, and IndyCar screens to include the interactive globe:

<write file="app/(tabs)/f1.tsx">
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>
          {f1Circuits.length} circuits • 2025/2026 season
        </Text>
          ...
          <>
            <View style={styles.searchContainer}>
              <SearchBar
                ...
                placeholder="Search F1 circuits..."
              />
            </View>
